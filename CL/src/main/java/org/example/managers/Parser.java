...
//        }
        ...
        PrepareRequest preparer = new PrepareRequest(this.queriesHandler, startRequest);
        ...
        while (true) {
            ...
            try {
                ...
                CommandRequest commandRequest = preparer.startPreparing(command, args);
                this.commandSender.send(commandRequest, this.selectionKey);
